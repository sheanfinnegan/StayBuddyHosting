...
<div id="popupCon"
    ...
    <div id="conLuar"
        ...
        <!-- Card List -->
        <div id="listCardUser"
            class="flex md:flex-row flex-col gap-10 md:gap-3 overflow-x-auto space-x-4 py-4 justify-center items-center h-fit">
            <!-- Card 1-->
            @if (!$users->isEmpty())
                @foreach ($users as $index => $user)
                    <div class="group perspective w-[300px] h-[480px] cursor-pointer mr-0">
